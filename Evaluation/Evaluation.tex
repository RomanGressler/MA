...
To ensure a good comparability further on the all task will be looked a separately. 
...
\begin{table}[htb]
  ...
  \begin{tabular}{lllll}
    ...
    \multicolumn{1}{l|}{Mann-Whitney-U} & $U=47 ;p \approx 0.58$ & $U=37.5;p \approx 0.81$ & $U=7.0;p \approx 0.003$  & $U= 24.5;p \approx 0.16$      \\ \hline
    ASQ Question                        & \multicolumn{4}{l}{Effort}      \\ \hline
    \multicolumn{1}{l|}{Group 1, Task:} & 1       & 2     & 3     & 4     \\
    \multicolumn{1}{l|}{Group 2, Task:} & 3       & 4     & 1     & 2     \\
    \multicolumn{1}{l|}{Mann-Whitney-U} & $U= 44;p \approx 0.78$        & $U=37 ;p \approx 0.78$      & $U= 13.5;p \approx 0.02$      & $U= 23;p \approx 0.11$      \\ \hline
...
\begin{figure}
  \centering
  \includegraphics*[width=1\textwidth]{Evaluation/img/effort_violin.png}
...
\begin{sidewaysfigure}
  \centering
  \includegraphics*[width=1.15\textwidth]{Evaluation/img/complexity_violin.png}
